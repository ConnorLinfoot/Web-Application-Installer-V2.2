...
exit;
	...
	if( $app == 'wordpress' ){ //Only run if Wordpress
...
function checkCMS($app){
	if( $app == 'wordpress' || $app == 'joomla2' || $app == 'joomla3' || $app == 'drupal7' || $app == 'eazycms' || $app == 'boxbilling' || $app == 'phpbb' ){
		return true;
	} else {
		return false;
	}
...
function downloadCMS($app){
	if( $app == 'wordpress' ){ $downloadFile = 'http://wordpress.org/latest.zip'; } else if( $app == 'joomla2' ){ $downloadFile = 'http://joomlacode.org/gf/download/frsrelease/19238/158101/Joomla_2.5.19-Stable-Full_Package.zip'; } else if( $app == 'joomla3' ){ $downloadFile = 'http://joomlacode.org/gf/download/frsrelease/19239/158104/Joomla_3.2.3-Stable-Full_Package.zip'; } else if( $app == 'drupal7' ){ $downloadFile = 'http://ftp.drupal.org/files/projects/drupal-7.26.zip'; } else if( $app == 'eazycms' ){ $downloadFile = 'http://eazycms.tk/download/EazyCMS_0.3.zip'; } else if( $app == 'boxbilling' ){ $downloadFile = 'http://www.boxbilling.com/version/latest.zip'; } else if( $app == 'phpbb' ){ $downloadFile = 'https://www.phpbb.com/files/release/phpBB-3.0.12.zip'; }
